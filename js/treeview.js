var sunburst_treeview = {
    initialize: function(){
        ...
        d3.json("json/promotion_tree.json",function(error, root){
            ...
            console.log(root.data[1].children)
            champion_name = root.data[1].name;
            contest_country = root.data[1].children[0].name+" vs "+ root.data[1].children[1].name;
            contest_score = root.data[1].children[0].score+" - "+root.data[1].children[1].score;
